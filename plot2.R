...
## 
## This R script named "plot2.R" performs the following:
...
## 4. A line plot of the Global Active Power is generated and labeled appropriately.
...
plot(hpcSub$timestamp, hpcSub$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
